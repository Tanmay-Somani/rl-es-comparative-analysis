...
class DistributedESAgent:
    ...
    def train(self, n_generations, log_data):
        ...
        with mp.Pool(processes=n_cores) as pool:
            for _ in tqdm(range(n_generations), desc="ES Distributed CartPole"):
...
def run_es_distributed(log_data):
    """Entry point to set up and run the Distributed ES benchmark for CartPole."""
    print("\nRunning Distributed Evolutionary Strategies on CartPole...")
    GAME_CONFIG = {
