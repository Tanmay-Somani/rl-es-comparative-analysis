...
def plot_results(log_data):
    """
    Plots the benchmark results for all specified experiments on CartPole.
    """
    ...
    plt.title('CartPole - CPU Usage Benchmark')
    plt.legend()
    plt.grid(True)
    plt.savefig('cartpole_cpu_usage_benchmark.png')
    ...
    plt.title('CartPole - Memory Usage Benchmark')
    plt.legend()
    plt.grid(True)
    plt.savefig('cartpole_memory_usage_benchmark.png')
    ...
    plt.title('CartPole - Training Time Benchmark')
    plt.legend()
    plt.grid(True)
    plt.savefig('cartpole_training_time_benchmark.png')
    ...
    plt.title('CartPole - Convergence Speed Benchmark')
    plt.legend()
    plt.grid(True)
    plt.savefig('cartpole_convergence_speed_benchmark.png')
    ...
    plt.title('CartPole - Communication Overhead Benchmark (Federated Methods)')
    plt.legend()
    plt.grid(True)
    plt.savefig('cartpole_communication_overhead_benchmark.png')
    ...
    plt.tight_layout()
    plt.savefig('cartpole_comprehensive_comparison.png', dpi=300, bbox_inches='tight')

    plt.show()
    print("CartPole benchmarking complete. Plots saved to the current directory.") 