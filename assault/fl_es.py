...
def run_fl_es(log_data, n_clients=5, n_rounds=20, local_generations=3):
    print("\nRunning Federated ES on Assault-v4 (RAM)...")
    ...
    for round_num in tqdm(range(n_rounds), desc="ES FL Assault"):
        local_models = []
